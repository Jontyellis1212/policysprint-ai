        ...
        <div className="mb-4 flex items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            <div className="hidden sm:block">
              <div className="text-[13px] font-medium text-slate-100">Training quiz generator</div>
              <div className="text-[11px] text-slate-400">Generate a quiz and export a styled PDF</div>
            </div>
          </div>
            ...
            <div>
              ...
              {prefilledFromStorage ? (
                <p className="mt-2 text-[11px] text-emerald-300">
                  ...
                  {autoGenerated && quiz && !loading ? <span className="text-emerald-200 font-medium"> Quiz auto-generated.</span> : null}
                </p>
              ) : (
                <p className="mt-2 text-[11px] text-slate-400">Tip: generate a policy in the wizard first, then come back here.</p>
              )}
            </div>
          </section>
          ...
          <div className="grid md:grid-cols-[3fr,2fr] gap-4">
            ...
            <section className={`${card} space-y-4`}>
              <form className="space-y-4" onSubmit={handleGenerate}>
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <select className={inputSm} value={numQuestions} onChange={(e) => setNumQuestions(Number(e.target.value) || 1)}>
                ...
                <div>
                  ...
                  />
                  <p className={`${hint} mt-1`}>The quiz focuses on allowed use, data handling, approvals, and escalation paths.</p>
                </div>

                {errorMessage ? (
                  <div className="rounded-xl border border-rose-900/40 bg-rose-950/30 px-4 py-3 text-[11px] text-rose-200">{errorMessage}</div>
                ) : null}

                {loading && !errorMessage ? (
                  <div className="text-[11px] text-slate-400">Drafting questions that match your policy and are clear for staff…</div>
                ) : null}
              </form>
              ...
              <div className="rounded-xl border border-slate-800 bg-slate-950/40 p-3">
                <div className="flex items-start justify-between gap-3 mb-2">
                  <div>
                    ...
                    <div className="text-[10px] text-slate-400">
                      Includes answer options A–D and a <span className="font-semibold text-slate-200">Correct answer</span> line.
                    </div>
                  </div>
                ...
                <div className="mb-2">
                  <EmailButton subject="AI Use Policy — Training Quiz" getBody={() => quiz || ""} label="Email this quiz" variant="dark" />
                </div>
            ...
            <section className={`${card} space-y-3`}>
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <input className={inputSm} value={businessName} onChange={(e) => setBusinessName(e.target.value)} placeholder="e.g. Bondi Physio Clinic" />
                </div>

                <div>
                  <label className={label}>Quiz title</label>
                  <input className={inputSm} value={quizTitle} onChange={(e) => setQuizTitle(e.target.value)} placeholder="AI Use Policy — Staff Quiz" />
                </div>
                ...
                {pdfError ? (
                  <div className="rounded-xl border border-rose-900/40 bg-rose-950/30 px-4 py-3 text-[11px] text-rose-200">{pdfError}</div>
                ) : null}
